...
"*****************************************************************************
""** this function separates plugin-core-function from
user                  **
"*****************************************************************************
...
"
"  "*****************************************************************************
"  "** this function separates plugin-core-function
"  from user                  **
"  "*****************************************************************************
...
"      plugin-core-function from user
"      **
"      "*****************************************************************************
...
"            "** input:  "str"
"            **
"            "** output: empty string: "str" is not an
"            operator                          **
"            "**         else:         name of tag to
"            go to                              **
"            "**
...
"
"                " get first character
"                    let l:firstChr = strpart(a:str,
    "                    0, 1)
    "
    "                        " is the first character of
    "                        the help-string an operator?
    "                            if
    "                            stridx("!&+-*/%,.:<=>?^|~(){}[]",
    "                            l:firstChr) >= 0
    "                                    return
    ...
    **
    ...
    "** remarks:
    "**
    ""**   This function tests whether or not "str" is
    an escape-sequence.       **
...
function s:IsItAComment(str)
    ...
    ""** input:  "str"
    **
    "** output: empty string: "str" is not a
    "preprocessor                       **
    ""**         else:         name of tag to go
    to                              **
    "**
    "**
    ""*****************************************************************************
    ...
    **
    ...
    ""**
    **
    "**   Nothing is done if the help-string is
    "equal to "if" or "else"         **
    ""**   because these are statements too. For
    "if" and "else" it's assumed    **
    ""**   that the statements are meant. But
    "#if" and "#else" are treated      **
...
function s:IsItAPreprocessor(str)
    ...
    "        
    "            " if first character of the help-string is a #, we have
    "            the command/operator
    "                " string in an appropriate form, so append this
    "                help-string to "stl-"
    "                    if l:firstChr == "#"
    "                            return "stl-" . a:str
    "                                else
    "                                        " no # in front of the help
    "                                        string, so evaluate which
    "                                        command/operator
    "                                                " is meant
    "                                                        if (a:str ==
    "                                                        "defined")
